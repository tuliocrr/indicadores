			...
			<?php foreach($lista as $linha){?>
				<tr>
					...
					if($visualizar){
						...
						echo $linha['Pessoa']['nome'];
					}
					?>&nbsp;</td>
					<td>
					<?php echo $linha['Usuario']['login']; ?>
					</td>
					<td>
					<?php echo $linha['Perfil']['titulo']; ?>
					</td>
					<td>
					<?php echo $linha['Vinculo']['titulo']; ?>
					</td>
					...
					<td width="7%" nowrap="nowrap" class="text-center">
						<?php 
							...
							echo $this->Html->link(
								__(""),
								array('action' => 'editar', $linha['Usuario']['id']),
							...
							echo $this->Form->postLink(
								__(""), 
								array('action' => 'excluir', $linha['Usuario']['id']), 
								array('class'=>'icon-trash'),
								__('Deseja realmente excluir o registro?', $linha['Usuario']['id'])
							);
							}
						?>
					</td>
