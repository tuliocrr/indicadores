 		...
 		<div class="row">
	  		<div class="span6">
	  			...
	  			<?php
					...
					echo $this->Form->input('Usuario.senha', array('type' => 'password', 'class' => 'input-xlarge', 'required'=>false));
					echo $this->Form->input('Usuario.confirmacao_senha', array('type' => 'password', 'class' => 'input-xlarge', 'required'=>false));
