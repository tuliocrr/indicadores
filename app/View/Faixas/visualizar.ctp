...
<div class="container">
	...
	<div class="buttons">
		...
		echo $this->Html->link(
					...
					array('action' => 'editar', $registro['Cargo']['id']),
		...
		if($excluir){
			echo $this->Form->postLink(
					...
					array('action' => 'excluir', $registro['Cargo']['id']), 
					array('class'=>'btn btn-small btn-primary pull-right', 'escape' => false),
			...
			<table cellpadding="0" cellspacing="0" class="table table-bordered table-hover table-condensed">
				<tbody>
					<tr>
						...
						<td><?php echo h($registro['Cargo']['titulo']); ?></td>
					</tr>
					<tr>
						<td><strong><?php echo __('Descrição'); ?></strong></td>
						<td><?php echo h($registro['Cargo']['descricao']); ?></td>
					</tr>
				</tbody>				
			</table>			
		</div>
