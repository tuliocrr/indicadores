...
<div class="container">
	...
	<div class="buttons">
		...
		echo $this->Html->link(
					...
					array('action' => 'editar', $registro['Departamento']['id']),
		...
		if($excluir){
			echo $this->Form->postLink(
					...
					array('action' => 'excluir', $registro['Departamento']['id']), 
					array('class'=>'btn btn-small btn-primary pull-right', 'escape' => false),
					__("Deseja realmente excluir o registro?", $registro['Departamento']['id'])
				);
		}
		?>
	</div>
			...
			<table cellpadding="0" cellspacing="0" class="table table-bordered table-hover table-condensed">
				<tbody>
					<tr>
						...
						<td><?php echo h($registro['Departamento']['titulo']); ?></td>
					</tr>					
				</tbody>				
			</table>			
		</div>
